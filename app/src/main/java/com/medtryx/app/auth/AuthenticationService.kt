...
class AuthenticationService(
    ...
    private companion object { val USERNAME = Regex("[a-z0-9._-]{3,50}"); val FRESH_AUTH_REQUIRED = setOf(Permission.FINALIZED_SALE_VOID_OR_REVERSE, Permission.SENSITIVE_EXPORT, Permission.BACKUP_RESTORE); const val MAX_FAILURES = 5; const val FAILURE_WINDOW_MILLIS = 5 * 60 * 1000L; const val INACTIVITY_TIMEOUT_MILLIS = 5 * 60 * 1000L; const val SESSION_LIFETIME_MILLIS = 8 * 60 * 60 * 1000L }
}
