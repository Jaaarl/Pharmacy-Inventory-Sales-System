...
**Gate:** Table-driven tests match approved examples to the centavo; invariants/property checks pass; changing current rules cannot change historical snapshots.
